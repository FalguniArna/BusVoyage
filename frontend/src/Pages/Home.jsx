import React, { useEffect, useRef, useState } from "react";import { useNavigate } from "react-router-dom";
      ...
      <div style={modal.box} onClick={e => e.stopPropagation()}>
        <div style={modal.header}>
          <div>
            ...
            <p style={modal.sub}>Covering all major areas around Metropolitan University, Sylhet</p>          </div>
...
const s = {
  ...
  hero:          { position: "relative", height: "100vh", minHeight: 500, background: "#2d3436", display: "flex", flexDirection: "column", justifyContent: "center", overflow: "hidden", paddingBottom: "140px" },
  ...
  heroTextCol:   { flex: 1, color: "#fff", paddingTop: "100px", display: "flex", flexDirection: "column", gap: "24px" },
