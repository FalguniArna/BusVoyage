...
export default function App(){ 
  return ( <div style={styles.page}>
      ...
      <section style={styles.heroSection}>
        ...
        <img src="/bus.png" style={styles.busImg} alt="bus" />
   ...
   <div style={styles.section}> 
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
       <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg hover:-translate-y-1 transition"> 
        ...
        <h3 className="font-semibold mt-2">Live Bus Tracking</h3> 
        <p className="text-sm text-gray-500 mt-2"> Real-time tracking system </p> 

        </div> <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg hover:-translate-y-1 transition"> 
          <div className="text-3xl mb-2">👥</div> 
          <h3 className="font-semibold mt-2">Crowd Status</h3> 

          <p className="text-sm text-gray-500 mt-2"> Check seat availability </p> 
          </div> 
          <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg hover:-translate-y-1 transition"> <div className="text-3xl mb-2">📢</div> 
          <h3 className="font-semibold mt-2">Announcements</h3> 
          
          <p className="text-sm text-gray-500 mt-2"> Stay updated easily </p> </div> <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg hover:-translate-y-1 transition"> <div className="text-3xl mb-2">🧾</div> 

          <h3 className="font-semibold mt-2">Complaints</h3> 
          <p className="text-sm text-gray-500 mt-2"> Report issues quickly </p> 
          </div> 
          </div> 
          </div>
      ...
      <div style={styles.section}>
        ...
        <div style={styles.gallery}>
          <img src="/p1.jpg" style={styles.galleryImg} />
          <img src="/download.jpg" style={styles.galleryImg} />
          <img src="/p2.jpg" style={styles.galleryImg} />
        </div>
      </div>
